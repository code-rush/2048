...
I am using this version as the recommended fork to avoid potential learning issues as the original source changes. You can [fork the original repo as well](https://github.com/gabrielecirulli/2048)
